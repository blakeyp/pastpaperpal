...
def extract_qs(file_path, paper_dir):

    # make new directory in media to store this stuff, name it by paper id

    # get paper from uploads/paper

    # paper_dir = 'media/papers/'+str(paper_id)
    # os.mkdir(paper_dir)

    #file_path = 'media/uploads/paper_'+str(paper_id)
...
class Crop:
    ...
    def do_crop(self, paper_dir, file_path, page_num, page_height):
        ...
        print 'pixel height:', self.top-self.bottom
